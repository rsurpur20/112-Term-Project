...
while True:
    ...
    if movingEyes:
        ...
        negibibledistance=0
        # print(leftEye.cx-leftPupil.cx,leftEye.cy-leftPupil.cy)
        ...
        elif originalLeftEyecy>leftPupil.cy and originalRightEyecy>rightPupil.cy:
            print("looking up")
            currY-=delta
        # elif originalLeftEyecy<leftPupil.cy and originalRightEyecy<rightPupil.cy:
        #     print("looking down")
        #     currY+=delta
        # elif originalLeftEyecy-leftPupil.cy>negibibledistance and originalRightEyecy-rightPupil.cy>negibibledistance:
        #     print("looking down")
        #     currY+=delta
